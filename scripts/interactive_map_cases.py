...
df_to_plot['Cases per 1,000,000 people'] = df_to_plot['Cases'] / df_to_plot['Population per 1,000,000']
...
fig = px.choropleth_mapbox(df_to_plot, geojson=counties_corrected, locations='nuts118cd', featureidkey="properties.nuts118cd", 
                    color='Cases per 1,000,000 people', color_continuous_scale="Magma_r", range_color=(0,70000),
...
fig.update_layout(
    title={'text': "<br>30-days totals of new cases per million people</br> from 01.04.2020 to 20.04.2022 by region",
        'y': 1,
        'x': 0.4,
        'xanchor': 'center',
        'yanchor': 'top'},
...
fig.write_html("../images/interactive_map_cases.html")
